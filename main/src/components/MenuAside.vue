...
export default {
	...
	methods: {
		...
		saveNavState(activePath) {
			// let currentPath = '';
			// if (this.$router.currentRoute.path.includes('/job')) {
			// 	currentPath = this.$router.currentRoute.path.replace('/job', '');
			// } else if (this.$router.currentRoute.path.includes('/language')) {
			// 	currentPath = this.$router.currentRoute.path.replace('/language', '');
			// }
